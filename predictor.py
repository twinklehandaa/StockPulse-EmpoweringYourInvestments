...
st.markdown(
    """
    <nav class='navbar'>
        <a href="C:/Users/hp/mp/home.html" target="_self">Home</a>
        <a href="C:/Users/hp/mp/menu.html" target="_self">Menu</a>
        <a href="C:/Users/hp/mp/aboutus.html" target="_self">About</a>
        <a href="C:/Users/hp/mp/contact.html" target="_self">Contact Us</a>
    </nav>
    """,
    unsafe_allow_html=True,
)
...
if st.button("Predict"):
    if stock_name in df['SYMBOL'].unique():
        ...
        st.markdown(f"<h3 style='color: white;'>Predicted future closing price for {stock_name}: {future_price[0]:.2f}</h3>", unsafe_allow_html=True)
...
st.markdown("<footer><p>&copy; 2024 Stock Market Prediction</p></footer>", unsafe_allow_html=True) 